...
![Image Alt](https://github.com/HarishDubbaka/Azure_Terraform/blob/4213c21d1b022709969f2969facfe0489a861cc0/Day20/azure-qr-code-architecture.png)
...
* `terraform apply` → Creates Azure infrastructure

After successful execution, all required Azure resources will be available.

---

## 🧩 Step 2: Prepare the Azure Function Code
...
🔹 `AzureWebJobsStorage` → Used by Azure Functions to store logs and output files
🔹 `FUNCTIONS_WORKER_RUNTIME` → Specifies Node.js runtime

---

## 🛠️ Step 3: Install Required Tools & Dependencies

### 1️⃣ Install Azure Functions Core Tools (v4)
...
### 3️⃣ Install Application Dependencies
...
✅ If Node.js is installed correctly, the worker runtime will start successfully.

---

## ☁️ Step 4: Publish Function Code to Azure
...
* The function appears in **Azure Portal → Function App → Functions**
...
✔ Azure Functions hosts serverless QR generation logic
✔ Node.js handles QR code generation
✔ Azure Storage stores generated QR images
